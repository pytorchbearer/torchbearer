...
import sconce
from sconce.callbacks import WeightDecay
...
class TestWeightDecay(TestCase):
    ...
    def test_single_parameter(self):
        ...
        self.assertTrue(state[sconce.LOSS].item() == 3)
    ...
    def test_multiple_parameters(self):
        ...
        self.assertTrue(state[sconce.LOSS].item() == 4)
    ...
    def test_rate(self):
        ...
        self.assertTrue(state[sconce.LOSS].item() == 2)
    ...
    def test_pow(self):
        ...
        self.assertTrue(state[sconce.LOSS].item() == 5)
