...
- Changed epoch number in printer callbacks to be consistent with the rest of sconce
### Deprecated
### Removed
### Fixed
...
## [0.1.2] - 2018-06-08
### Added
- Added support for tuple outputs from generators, sconce expects output to be length 2. Specifically, x, y = next() is possible, where x and y can be tuples of arbitrary size or depth
- Added support for torch dtypes in sconce Model.to(...)
